...
import numpy as np
import os
if not os.path.exists('./data_generate/NYT'):
    os.makedirs('./data_generate/NYT')
...
sim_entity1_path='./similarity_match/NYT/sim_Entity1_1000.json'
sim_entity2_path='./similarity_match/NYT/sim_Entity2_1000.json'
sim_relation_Message_path='./similarity_match/NYT/sim_Relation_Message_1000.json'
...
with open('./data_generate/NYT/train_entity1_1000.json','w') as file_obj:
    json.dump(data_generate_entity1,file_obj,ensure_ascii=False)
with open('./data_generate/NYT/train_entity2_1000.json','w') as file_obj:
    json.dump(data_generate_entity2,file_obj,ensure_ascii=False)
with open('./data_generate/NYT/train_relation_1000.json','w') as file_obj:
    json.dump(data_generate_relation,file_obj,ensure_ascii=False)
with open('./data_generate/NYT/train_triples_all_1000.json','w') as file_obj:
