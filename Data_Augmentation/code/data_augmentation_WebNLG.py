...
import numpy as np
import os
if not os.path.exists('./data_generate/WebNLG'):
    os.makedirs('./data_generate/WebNLG')
file_path='./data/WebNLG/train_triples.json'
...
sim_entity1_path='./similarity_match/WebNLG/sim_Entity1_1000.json'
sim_entity2_path='./similarity_match/WebNLG/sim_Entity2_1000.json'
sim_relation_Message_path='./similarity_match/WebNLG/sim_Relation_Message_1000.json'
...
with open('./data_generate/WebNLG/train_entity1_1000.json','w') as file_obj:
    json.dump(data_generate_entity1,file_obj,ensure_ascii=False)
with open('./data_generate/WebNLG/train_entity2_1000.json','w') as file_obj:
    json.dump(data_generate_entity2,file_obj,ensure_ascii=False)
with open('./data_generate/WebNLG/train_relation_1000.json','w') as file_obj:
    json.dump(data_generate_relation,file_obj,ensure_ascii=False)
with open('./data_generate/WebNLG/train_triples_all_1000.json','w') as file_obj:
