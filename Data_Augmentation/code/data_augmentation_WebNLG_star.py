...
import numpy as np
import os
if not os.path.exists('./data_generate/WebNLG_star'):
    os.makedirs('./data_generate/WebNLG_star')
...
sim_entity1_path='./similarity_match/WebNLG_star/sim_Entity1_1000.json'
sim_entity2_path='./similarity_match/WebNLG_star/sim_Entity2_1000.json'
sim_relation_Message_path='./similarity_match/WebNLG_star/sim_Relation_Message_1000.json'
...
print(len(sim_entity1_data))
print(len(sim_entity2_data))
print(len(sim_relation_Message_data))
...
for sort_entity1_index in range(len(sim_entity1_data)):
    ...
    # print(len(relation_Property))
    # print(sim_entity1_data[sort_entity1_index]['head1_index'])
    # print(sim_entity1_data[sort_entity1_index]['head1_n_index'])
    # print(sim_entity1_data[sort_entity1_index]['head2_index'])
    # print(sim_entity1_data[sort_entity1_index]['head2_n_index'])
    # print(sim_entity1_data[sort_entity1_index]["similarity"])
    # print(relation_Property[sim_entity1_data[sort_entity1_index]['head1_index']][sim_entity1_data[sort_entity1_index]['head1_n_index']])
    # print(relation_Property[sim_entity1_data[sort_entity1_index]['head2_index']][sim_entity1_data[sort_entity1_index]['head2_n_index']])
    if sim_entity1_data[sort_entity1_index]["head1"]!=sim_entity1_data[sort_entity1_index]["head2"] and sim_entity1_data[sort_entity1_index]["similarity"]>float(threshold) and relation_Property[sim_entity1_data[sort_entity1_index]['head1_index']][sim_entity1_data[sort_entity1_index]['head1_n_index']]==relation_Property[sim_entity1_data[sort_entity1_index]['head2_index']][sim_entity1_data[sort_entity1_index]['head2_n_index']]:
        # print(sim_entity1_data[sort_entity1_index]["head1"],"  ",sim_entity1_data[sort_entity1_index]["head2"])
        two_cell={}
        three_cell=[]
        for list_sim_index in range(len(data[sim_entity1_data[sort_entity1_index]['head1_index']]['triple_list'])):
            ...
            if entity1[sim_entity1_data[sort_entity1_index]['head1_index']][list_sim_index]==sim_entity1_data[sort_entity1_index]['head1']:
                new_one_generate_relation=relation_Property[sim_entity1_data[sort_entity1_index]['head1_index']][sim_entity1_data[sort_entity1_index]['head1_n_index']]
        ...
        for list_sim_index in range(len(data[sim_entity1_data[sort_entity1_index]['head2_index']]['triple_list'])):
            ...
            if entity1[sim_entity1_data[sort_entity1_index]['head2_index']][list_sim_index]==sim_entity1_data[sort_entity1_index]['head2']:
                new_one_generate_relation=relation_Property[sim_entity1_data[sort_entity1_index]['head2_index']][sim_entity1_data[sort_entity1_index]['head2_n_index']]
    ...
    if sim_entity2_data[sort_entity2_index]["tail1"]!=sim_entity2_data[sort_entity2_index]["tail2"] and sim_entity2_data[sort_entity2_index]["similarity"]!=1 and sim_entity2_data[sort_entity2_index]["similarity"]>float(threshold) and relation_Property[sim_entity2_data[sort_entity2_index]['tail1_index']][sim_entity2_data[sort_entity2_index]['tail1_n_index']]==relation_Property[sim_entity2_data[sort_entity2_index]['tail2_index']][sim_entity2_data[sort_entity2_index]['tail2_n_index']]:
        ...
        for list_sim_index in range(len(data[sim_entity2_data[sort_entity2_index]['tail1_index']]['triple_list'])):
            ...
            if entity2[sim_entity2_data[sort_entity2_index]['tail1_index']][list_sim_index]==sim_entity2_data[sort_entity2_index]['tail1']:
                new_one_generate_relation=relation_Property[sim_entity2_data[sort_entity2_index]['tail1_index']][sim_entity2_data[sort_entity2_index]['tail1_n_index']]
        ...
        for list_sim_index in range(len(data[sim_entity2_data[sort_entity2_index]['tail2_index']]['triple_list'])):
            ...
            if entity2[sim_entity2_data[sort_entity2_index]['tail2_index']][list_sim_index]==sim_entity2_data[sort_entity2_index]['tail2']:
                new_one_generate_relation=relation_Property[sim_entity2_data[sort_entity2_index]['tail2_index']][sim_entity2_data[sort_entity2_index]['tail2_n_index']]
...
for sort_relation_index in range(len(sim_relation_Message_data)):
    ...
    if sim_relation_Message_data[sort_relation_index]['relation1']!=sim_relation_Message_data[sort_relation_index]['relation2'] and sim_relation_Message_data[sort_relation_index]["similarity"]>float(threshold) and relation_Property[sim_relation_Message_data[sort_relation_index]['relation1_index']][sim_relation_Message_data[sort_relation_index]['relation1_n_index']]==relation_Property[sim_relation_Message_data[sort_relation_index]['relation2_index']][sim_relation_Message_data[sort_relation_index]['relation2_n_index']]:
        # print(sim_relation_Message_data[sort_relation_index]['relation1'],"  -----  ",sim_relation_Message_data[sort_relation_index]['relation2'])
        two_cell={}
        three_cell=[]
        for list_sim_relation in range(len(data[sim_relation_Message_data[sort_relation_index]['relation1_index']]['triple_list'])):
            four_cell=[]
            if relation_Property[sim_relation_Message_data[sort_relation_index]['relation2_index']][sim_relation_Message_data[sort_relation_index]['relation2_n_index']]==relation_Property[sim_relation_Message_data[sort_relation_index]['relation1_index']][list_sim_relation]:
                new_one_generate_relation=relation_Property[sim_relation_Message_data[sort_relation_index]['relation1_index']][sim_relation_Message_data[sort_relation_index]['relation1_n_index']]
        ...
        for list_sim_relation in range(len(data[sim_relation_Message_data[sort_relation_index]['relation2_index']]['triple_list'])):
            four_cell=[]
            if relation_Property[sim_relation_Message_data[sort_relation_index]['relation1_index']][sim_relation_Message_data[sort_relation_index]['relation1_n_index']]==relation_Property[sim_relation_Message_data[sort_relation_index]['relation2_index']][list_sim_relation]:
                new_one_generate_relation=relation_Property[sim_relation_Message_data[sort_relation_index]['relation2_index']][sim_relation_Message_data[sort_relation_index]['relation2_n_index']]
...
with open('./data_generate/WebNLG_star/train_entity1_1000.json','w') as file_obj:
    json.dump(data_generate_entity1,file_obj,ensure_ascii=False)
with open('./data_generate/WebNLG_star/train_entity2_1000.json','w') as file_obj:
    json.dump(data_generate_entity2,file_obj,ensure_ascii=False)
with open('./data_generate/WebNLG_star/train_relation_1000.json','w') as file_obj:
    json.dump(data_generate_relation,file_obj,ensure_ascii=False)
with open('./data_generate/WebNLG_star/train_triples_all_1000.json','w') as file_obj:
