...
import numpy as np
import os
if not os.path.exists('./data_decomposition/NYT_star'):
    os.makedirs('./data_decomposition/NYT_star')
...
with open('./data_decomposition/NYT_star/entity1.json','w') as file_obj:
    json.dump(entity1,file_obj,ensure_ascii=False)
with open('./data_decomposition/NYT_star/entity2.json','w') as file_obj:
    json.dump(entity2,file_obj,ensure_ascii=False)
with open('./data_decomposition/NYT_star/entity1_properity.json','w') as file_obj:
    json.dump(entity1_Property,file_obj,ensure_ascii=False)
with open('./data_decomposition/NYT_star/entity2_properity.json','w') as file_obj:
...
with open('./data_decomposition/NYT_star/relation.json','w') as file_obj:
    json.dump(relation_Message,file_obj,ensure_ascii=False)
with open('./data_decomposition/NYT_star/relation_properity.json','w') as file_obj:
