...
import numpy as np
import os
if not os.path.exists('./data_decomposition/WebNLG'):
    os.makedirs('./data_decomposition/WebNLG')
...
with open('./data_decomposition/WebNLG/entity1.json','w') as file_obj:
    json.dump(entity1,file_obj,ensure_ascii=False)
with open('./data_decomposition/WebNLG/entity2.json','w') as file_obj:
...
with open('./data_decomposition/WebNLG/relation.json','w') as file_obj:
    json.dump(relation_Message,file_obj,ensure_ascii=False)
with open('./data_decomposition/WebNLG/relation_properity.json','w') as file_obj:
