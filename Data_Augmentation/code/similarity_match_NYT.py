...
import numpy as np
import os
if not os.path.exists('./similarity_match/NYT'):
    os.makedirs('./similarity_match/NYT')

from similarities import Similarity
m = Similarity(model_name_or_path="sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
entity1_path='./data_decomposition/NYT/entity1.json'
entity2_path='./data_decomposition/NYT/entity2.json'
relation_Message_path='./data_decomposition/NYT/relation.json'

entity1_properity_path='./data_decomposition/NYT/entity1_properity.json'
entity2_properity_path='./data_decomposition/NYT/entity2_properity.json'
relation_Message_properity_path='./data_decomposition/NYT/relation._properityjson'
...
with open('./similarity_match/NYT/sim_Entity1.json','w') as file_obj:
    json.dump(sim_Entity1,file_obj,ensure_ascii=False)
with open('./similarity_match/NYT/sim_Entity2.json','w') as file_obj:
    json.dump(sim_Entity2,file_obj,ensure_ascii=False)
with open('./similarity_match/NYT/sim_Relation_Message.json','w') as file_obj:
