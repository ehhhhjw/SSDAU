...
import numpy as np
import os
if not os.path.exists('./similarity_match/WebNLG'):
    os.makedirs('./similarity_match/WebNLG')
from similarities import Similarity
m = Similarity(model_name_or_path="sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
entity1_path='./data_decomposition/WebNLG/entity1.json'
entity2_path='./data_decomposition/WebNLG/entity2.json'
relation_Message_path='./data_decomposition/WebNLG/relation.json'
relation_Message_properity_path='./data_decomposition/WebNLG/relation_properity.json'
...
with open('./data_decomposition/WebNLG/sim_Entity1.json','w') as file_obj:
    json.dump(sim_Entity1,file_obj,ensure_ascii=False)
with open('./data_decomposition/WebNLG/sim_Entity2.json','w') as file_obj:
    json.dump(sim_Entity2,file_obj,ensure_ascii=False)
with open('./data_decomposition/WebNLG/sim_Relation_Message.json','w') as file_obj:
